...
import { CnsQueueMessage } from "types/ccd"
...
const CnsQueueSubscriber: Subject<CnsQueueMessage> = new Subject()
const CnsQueueMessageService = {
  send: function (msg: any) {
    CnsQueueSubscriber.next(msg)
  },
}
