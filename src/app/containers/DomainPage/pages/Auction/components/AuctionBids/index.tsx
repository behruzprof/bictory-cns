...
import { ReactComponent as FireIcon } from "images/icons/fireIcon.svg"
import {
  Box,
  Table,
  TableBody,
...
export const AuctionBids: FC = () => {
  ...
  return (
    <>
      <BTitle color={CssVariables.White} size="h5">
        Auction Bids
      </BTitle>
      <BText mt={1} mb={3}>
        ...
        {isLoading ? (
          ...
          <>
            {bidsList.length <= 0 ? (
              ...
              >
                <BText size="l" color={CssVariables.White} mb={1}>
                  No bids yet
                </BText>
              </Box>
            ) : (
                        ...
                        <TableRow key={id}>
                          <TableCell scope="row">
                            <GridItem>
                              ...
                              <BText color={CssVariables.Gray5}>{holder}</BText>
                            </GridItem>
                          </TableCell>
                          <TableCell align="right">
                            <GridItem>
                              <ConcordiumLogo />
                              <BText color={CssVariables.White} size="l">
                                {MicroCCDToCCD(bid)}
                              </BText>
                            </GridItem>
                          </TableCell>
                          <TableCell align="right">
                            <GridItem>
                              <BText color={CssVariables.Gray4}>
