...
export const CreateSubdomain = () => {
  ...
  const isOpen = useSelector(GlobalSelectors.isOpenCreateSubdomain)
  ...
  return (
    ...
    >
      ...
      <BText size="s" pl={3} color={CssVariables.Gray3}>
      ...
      {helperText && (
        <BText size="s" pl={3} color={CssVariables.Error} textAlign="center">
          {helperText}
        </BText>
      )}
