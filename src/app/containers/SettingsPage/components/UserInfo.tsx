        ...
        >
          {() => (
            <Form>
              ...
              <HideDomainsWrapper>
                <HideDomains>
                  <BText size="l">Hide domains in wallet for others</BText>
                  <BText size="m" color={CssVariables.Gray3}>
                    This feature lets you hide your domains and make them
                    invisible to other users on the app interface.
                  </BText>
                </HideDomains>

                <Field
                  component={FormikBChekbox}
                  name="is_hide_dmns_for_other"
                />
              </HideDomainsWrapper> */}
              <Spacer vSpace={CssVariables.Space72} />
              {!userData?.lined_in_email ? (
                <>
                  <SocialConnection>
                    <Box display="flex" flexDirection="column">
                      <BText size="l">Social Connection</BText>
                      <BText size="m" color={CssVariables.Gray3}>
                        Help collectors verify you by connect your linkedin.
                      </BText>
                    </Box>
                    <BButton
                      btn="outlinePrimary"
                      onClick={linkedInLogin}
                      loadingLabel="Connection..."
                      isLoading={isSavingLinkedIn}
                    >
                      <LinkedinIcon />
                      Connect LinkedIn
                    </BButton>
                ...
                <>
                  <InputLabel> Linkedin email</InputLabel>
                  <StyledInput value={userData?.lined_in_email} disabled />
                </>
              )}
              <Spacer vSpace={CssVariables.Space40} />
              {/* <BButton
